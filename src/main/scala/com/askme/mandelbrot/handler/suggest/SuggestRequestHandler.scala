...
class SuggestRequestHandler(val config: Config, serverContext: SearchContext) extends Actor with Configurable with Logging {
  ...
  private def buildQuery(suggestParams: SuggestParams): QueryBuilder = {
    ...
    nestedQuery("targeting",
      query
        .add(shingleSpan("targeting.kw.keyword", 1e12.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("1"))
        .add(shingleSpan("targeting.kw.keyword", 1e11.toInt, wordskw, 1, wordskw.length, wordskw.length, false, true).queryName("2"))
        .add(shingleSpan("targeting.kw.keyword_edge_ngram", 1e11.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("3"))
        .add(shingleSpan("targeting.kw.shingle", 1e10.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("4"))
        .add(shingleSpan("targeting.kw.shingle", 1e9.toInt, wordskw, 1, wordskw.length, wordskw.length, false, true).queryName("5"))
        .add(shingleSpan("targeting.kw.token", 1e9.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("6"))
        .add(shingleSpan("targeting.kw.token", 1e8.toInt, wordskw, 1, wordskw.length, wordskw.length, false, true).queryName("7"))
        .add(shingleSpan("targeting.kw.shingle_nospace", 1e8.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("8"))
        .add(shingleSpan("targeting.kw.shingle_nospace", 1e7.toInt, wordskw, 1, wordskw.length, wordskw.length, false, true).queryName("9"))
        .add(shingleSpan("targeting.kw.shingle_edge_ngram", 1e6.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("10"))
        .add(shingleSpan("targeting.kw.token_edge_ngram", 1e6.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("11"))
        .add(shingleSpan("targeting.kw.shingle_nospace_edge_ngram", 1e5.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("12"))
        .add(shingleSpan("targeting.kw.keyword_edge_ngram", 1e4.toInt, wordskw, 1, wordskw.length, wordskw.length, false, true).queryName("13"))
        .add(shingleSpan("targeting.kw.shingle_nospace_edge_ngram", 1e4.toInt, wordskw, 1, wordskw.length, wordskw.length, false, true).queryName("14"))
        .add(shingleSpan("targeting.kw.keyword_ngram", 1e3.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("15"))
        .add(shingleSpan("targeting.kw.keyword_ngram", 1e3.toInt, wordskwng, 1, wordskwng.length, wordskwng.length, true, false).queryName("16"))
        .add(shingleSpan("targeting.kw.shingle_nospace_ngram", 1e2.toInt, wordsshnspng, 1, wordsshnspng.length, wordsshnspng.length, true, false).queryName("17"))
        .add(shingleSpan("targeting.label.keyword", 1e16.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("label_1"))
        .add(shingleSpan("targeting.label.keyword_edge_ngram", 1e15.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("label_2"))
        .add(shingleSpan("targeting.label.shingle", 1e14.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("label_3"))
        .add(shingleSpan("targeting.label.token", 1e13.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("label_4"))
        .add(shingleSpan("targeting.label.shingle_nospace", 1e12.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("label_5"))
        .add(shingleSpan("targeting.label.shingle_edge_ngram", 1e11.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("label_6"))
        .add(shingleSpan("targeting.label.token_edge_ngram", 1e11.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("label_7"))
        .add(shingleSpan("targeting.label.shingle_nospace_edge_ngram", 1e10.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("label_8"))
        .add(shingleSpan("targeting.label.keyword_ngram", 1e9.toInt, wordskw, 1, wordskw.length, wordskw.length, false, false).queryName("label_9"))

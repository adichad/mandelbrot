...
case class DealFilterParams(id: String, applicableTo: String, category: String, featured: Boolean, dealsource: String, pay_merchant_id: String, edms_outlet_id: Int, gll_outlet_id: Int, pay_type: Int) extends RestMessage
